...
// A.C. I inherit this from TObject
class JObject: public TObject{
	...
	public:
		...
		string GetNameJANA(void) const {return string(className());}
		string GetTag(void) const ;
		string GetNameTag(void) const {return GetNameJANA() + (GetTag()=="" ? "":":") + GetTag();}
