...
// brun
//------------------
jerror_t CalorimeterSiPMHit_factory::brun(jana::JEventLoop *eventLoop, int runnumber)
{
	return NOERROR;
}
...
// evnt
//------------------
jerror_t CalorimeterSiPMHit_factory::evnt(JEventLoop *loop, int eventnumber)
{
