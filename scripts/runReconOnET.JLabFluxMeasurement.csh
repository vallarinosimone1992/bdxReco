...
$BDXRECO_ROOT/bin/bdxReco --config=$BDXRECO_ROOT/config/bdx.config.JLabFlux.online -PPLUGINS=monitoring_rootspy,monitoring_DAQWaveformsMode1,monitoring_IntVetoSipm,monitorint_Trigger ET:bdxtest:DSTMaker:jdaq8:11111
