...
sh -c "exec -a bdxReco_onlineDST $BDXRECO_ROOT/bin/bdxReco -PTT:XML_FILENAME="$BDXRECO_ROOT/tt.JLabFluxMeasurement.xml" --config=$BDXRECO_ROOT/config/bdx.config.JLabFlux.online --plugin=andrea_janaview ET:bdxtest:DSTMaker:jdaq3.ge.infn.it:11111"
